...
public class Server {
    ...
    private static void InitializeServerData() {
        ...
        packetHandlers = new Dictionary<int, PacketHandler>() {
            { (int)ClientPackets.requestToJoinServer, ServerReceive.RequestToJoinServer },
            { (int)ClientPackets.chooseHero, ServerReceive.ChooseHero },
            { (int)ClientPackets.movement, ServerReceive.Movement },
            { (int)ClientPackets.jumpInput, ServerReceive.JumpInput },
            { (int)ClientPackets.abilityPressed, ServerReceive.AbilityPressed },
            { (int)ClientPackets.dungeonLoaded, ServerReceive.DungeonLoaded }
        };
